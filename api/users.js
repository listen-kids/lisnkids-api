  ...
  try {
    ...
    if (!user) {
      ...
      if (
        ...
        req.fields.userName && (user.account.userName = req.fields.userName);
        req.fields.guidance && (user.account.guidance = req.fields.guidance);
        req.fields.guidance1 && (user.account.guidance1 = req.fields.guidance1);
        req.fields.guidance2 && (user.account.guidance2 = req.fields.guidance2);
        req.fields.languageDefault &&
